...
class ScriptsControllerTest < ActionController::TestCase
  ...
  test "should create script" do
    assert_difference('Script.count') do
      post :create, script: { event_id: @script.event_id, sdata: @script.sdata, title: @script.title, user_id: @script.user_id }
    end
  ...
  test "should update script" do
    patch :update, id: @script, script: { event_id: @script.event_id, sdata: @script.sdata, title: @script.title, user_id: @script.user_id }
    assert_redirected_to script_path(assigns(:script))
  end
